...
struct DragSessionState: Equatable {
    ...
    func wantsSnapOverlay(snapWhileDragging: Bool, snapSuppressed: Bool = false) -> Bool {
        guard isDragging, !snapSuppressed else { return false }
        return snapWhileDragging ? !isSnapKeyPressed : isSnapKeyPressed
    }
